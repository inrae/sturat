...
class TraitClass extends PpciModel
{
  ...
  {
    $children = array(
      array("name" => "Traitgeom", "file" => "traitgeom.class.php"),
      array("name" => "Traittrace", "file" => "traittrace.class.php"),
      array("name" => "Physicochimie", "file" => "physicochimie.class.php"),
      array("name" => "Echantillon", "file" => "echantillon.class.php"),
      array("name" => "Traitdebris", "file" => "traitdebris.class.php"),
      array("name" => "IndividuSturio", "file" => "individuSturio.class.php"),
      array("name" => "Eel", "file" => "eel.class.php"),
      array("name" => "Sonde", "file" => "sonde.class.php")
    );
    foreach ($children as $child) {
      $childInstance = $this->classInstanciate($child["name"], $child["file"]);
